...
public class ActionNode : IDisposable
{
    ...
    private readonly List<ActionNode> children = new();
    ...
    private ActionNode(Action action) : this()
    {
        Id = action.Id;
        Label = action.Label;
    ...
    private ActionNode(Category category) : this()
    {
        Id = category.Id;
    ...
    private ActionNode(ActionSet actionset) : this()
    {
        Id = actionset.Id;
    ...
    private readonly UTF8String m_label = new();
    ...
    private readonly UTF8String m_description = new();
    ...
    private ActionNode Add(ActionNode child)
    {
        ...
        if (pinned_node != IntPtr.Zero)
        {
            ...
            else
            {
                ...
                children[^1]._node.next = next;
                Marshal.WriteIntPtr(children[^1].pinned_node, (int)Marshal.OffsetOf(typeof(SiApp.SiActionNodeEx_t), "next"), next);
            }
        }
