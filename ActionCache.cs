...
public class ActionCache : IDisposable
{
    ...
    private readonly ActionTree m_tree = new();
    private readonly List<ImageItem> m_images = new();
    ...
    public void SaveImagesTo3Dxware(IntPtr hdl)
    {
        ...
        List<SiApp.SiImage_s> images = new();
        ...
        Action<ActionNode> unpinImage = (node) => { node.Image?.UnpinObject(); };
